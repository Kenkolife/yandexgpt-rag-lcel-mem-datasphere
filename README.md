...
1. Откройте в проекте ноутбук [YandexGPT_OpenSearch_LCEL_memory.ipynb](YandexGPT_OpenSearch_LCEL_memory.ipynb) и выполните все ячейки кода.
...
2. Далее мы генерируем векторные эмбеддинги по фрагментам текста с помощью Yandex GPT Embedding API (используем класс YandexEmbeddings из библиотеки [yandex-chain](https://pypi.org/project/yandex-chain/)) 
